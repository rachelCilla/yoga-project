				...
				<main className="p-8 relative w-screen h-screen bg-bottom bg-cover bg-[url('../images/kike-vega-F2qh3yjz6Jk-unsplash.jpg')] font-mont">
					...
					<section className="absolute top-44 grid grid-cols-1 md:grid-cols-3 md:gap-10 left-1/2 transform -translate-x-1/2 w-10/12 ">
						...
						<article className="cardGrowGlow flex flex-col p-8 bg-primary1/80 rounded shadow border-2 border-primary2  ">
							...
							<div className="pose-card-p-background">
								<p className="text-primary5 mb-3">
									Explore a variety of yoga poses categorized by their specific categories, including Core Yoga
									for strengthening the core muscles, Seated Yoga for poses performed in a seated position, Chest
									Opening Yoga for poses that open and expand the chest area, and Backbend Yoga for poses that
									focus on bending the spine and opening the back.
								</p>
							</div>
							{/* search btn 1 */}
						...
						<article className="cardGrowGlow flex flex-col p-8 bg-primary1/80 rounded shadow border-2 border-primary2 ">
							...
							<div className="pose-card-p-background">
								<p className=" text-primary5 mb-3">
									...
									intermediate, to advanced, empowering practitioners to choose poses that align with their skill
						...
						<article className="cardGrowGlow flex flex-col p-8 bg-primary1/80 rounded shadow border-2 border-primary2 ">
							...
							<div className="">
								<p className="text-primary5 mb-3">
									Find yoga poses based on their specific benefits, such as strengthening the abdomen, relieving
									stress, improving posture, relieving menopausal and menstrual discomfort, reducing anxiety,
									fatigue, backache, headache, and insomnia, and providing therapeutic effects for conditions like
									asthma, high blood pressure, osteoporosis, and sinusitis.
								</p>
							</div>
							{/* search btn 3 */}
